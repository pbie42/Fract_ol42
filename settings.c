...
/*   Updated: 2016/03/18 18:21:47 by pbie             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_julia_set(t_mlx *m)
{
	...
	y = 0;
	mlx_string_put(m->mlx, m->win, FRAC_X, y + 256, 0xccccff, L_TRANS);
	mlx_string_put(m->mlx, m->win, FRAC_X, y + 272, 0xccccff, L_HOLD);
}
...
void			ft_putset(t_mlx *mlx)
{
	...
	mlx_string_put(mlx->mlx, mlx->win, FRAC_X, y + 192, 0xccccff, L_BURN);
	mlx_string_put(mlx->mlx, mlx->win, FRAC_X, y + 208, 0xccccff, L_RESET);
	mlx_string_put(mlx->mlx, mlx->win, FRAC_X, y + 224, 0xccccff, L_ESC);
